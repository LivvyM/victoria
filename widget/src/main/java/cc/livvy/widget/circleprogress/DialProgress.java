package cc.livvy.widget.circleprogress;
...
import cc.livvy.widget.circleprogress.utils.Constant;
import cc.livvy.widget.circleprogress.utils.MiscUtil;
...
public class DialProgress extends View {
    ...
    private float mSpaceOffset;
    private CharSequence mUnit;
    private CharSequence mSpace = "60-100";
    //前景圆弧
    ...
    private void initConfig(Context context, AttributeSet attrs) {
        ...
        mBgArcColor = typedArray.getColor(R.styleable.DialProgress_bgArcColor, Color.WHITE);
        mDialWidth = typedArray.getDimension(R.styleable.DialProgress_dialWidth, 6);
        mDialColor = typedArray.getColor(R.styleable.DialProgress_dialColor, Color.WHITE);

        mTextOffsetPercentInRadius = typedArray.getFloat(R.styleable.DialProgress_textOffsetPercentInRadius, 0.50f);
    ...
    private void initPaint() {
        ...
        mArcPaint.setPathEffect(new DashPathEffect(new float[]{5, 25}, 0));
        ...
        mBgArcPaint.setPathEffect(new DashPathEffect(new float[]{5, 25}, 0));
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        mUnitOffset = mCenterPoint.y + getBaselineOffsetFromY(mValuePaint) + getBaselineOffsetFromY(mUnitPaint) + MiscUtil.dipToPx(getContext(), 8);
        mSpaceOffset = mCenterPoint.y + getBaselineOffsetFromY(mValuePaint) + getBaselineOffsetFromY(mUnitPaint) + MiscUtil.dipToPx(getContext(), 30);
...
//        drawDial(canvas);
    ...
    private void drawText(Canvas canvas) {
        ...
        if (mSpace != null) {
            canvas.drawText(mSpace.toString(), mCenterPoint.x, mSpaceOffset, mUnitPaint);
        }
    }
